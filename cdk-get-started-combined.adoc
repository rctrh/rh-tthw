...
First, download and install a virtualization platform that is appropriate for your development system:

* link:http://virtualbox.org/[VirtualBox]
* link:http://vmware.com/[VMware]
* Linux KVM/libvirt

If you are using Microsoft Windows, Apple Mac OS X, or a Linux distribution other than Fedora or CentOS, VirtualBox is recommended.
