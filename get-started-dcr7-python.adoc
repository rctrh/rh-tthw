...
In this tutorial, you will learn how to start building Python 3 applications in docker containers on Red Hat Enterprise Linux. In order to be able to build and run containers you will install `docker` on a system running the server edition of Red Hat Enterprise Linux 7.
