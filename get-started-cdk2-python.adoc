...
. Download the `rhel-cdk-kubernetes` box that matches your virtualization provider (VirtualBox, VMware, or KVM/libvirt).  Note the file name/path of the saved `.box` file.
