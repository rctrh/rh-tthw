...
In this tutorial, you will see how to get started with Ruby development on Red Hat Enterprise Linux by creating a simple Hello World application. The tutorial will take five to ten minutes to complete.
...
Now we will create a Ruby application that can be run from the command line. Using your preferred text editor, create hello.rb: 
