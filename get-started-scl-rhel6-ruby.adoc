...
## Path Intro section
Get started developing with Ruby 2.2 from Red Hat Software Collections in under 10 minutes.
...
Under your normal user ID, start a _Terminal_ window.  First, use `scl enable` to add Ruby 2.2 to your environment, then we will run interative Ruby to see the version number.
