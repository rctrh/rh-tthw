...
Under your normal user ID, start a terminal session. First, use `scl enable` to add PHP 5.6 to your environment, then run PHP in interactive mode to see the versionn number.
