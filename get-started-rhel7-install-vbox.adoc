...
.. Click _Next_.
+
// image:#{cdn(site.base_url + '/images/products/rhel/rhel7-install/vbox/vbox-02-create.png')}[Screenshot Boot Splash]
image::images/rhel7-install/vbox/vbox-02-create.png[Screenshot Create VM]
+
...
// image:#{cdn(site.base_url + '/images/products/rhel/rhel7-install/vbox/vbox-05-hd4.png')}[Screenshot HD Dynamic]
image::images/rhel7-install/vbox/vbox-05-hd4.png[Screenshot HD Dynamic]
...
.. Click _Create_.
// image:#{cdn(site.base_url + '/images/products/rhel/rhel7-install/vbox/vbox-05-hd2.png')}[Screenshot File Location]
image::images/rhel7-install/vbox/vbox-05-hd2.png[Screenshot File Location]
...
// image:#{cdn(site.base_url + '/images/products/rhel/rhel7-install/vbox/vbox-06-settings1.png')}[Screenshot VM Created]
image::images/rhel7-install/vbox/vbox-06-settings1.png[Screenshot VM Created]
...
+
// image:#{cdn(site.base_url + '/images/products/rhel/rhel7-install/vbox/vbox-06-settings2.png')}[Screenshot Settings Advanced]
image::images/rhel7-install/vbox/vbox-06-settings1.png[Screenshot Settings Advanced]
+
...
+
// image:#{cdn(site.base_url + '/images/products/rhel/rhel7-install/vbox/vbox-06-settings3.png')}[Screenshot Settings Processor]
image::images/rhel7-install/vbox/vbox-06-settings3.png[Screenshot Settings Processor]
+
...
// image:#{cdn(site.base_url + '/images/products/rhel/rhel7-install/vbox/vbox-04-settings4.png')}[Screenshot Settings RHEL DVD]
image::images/rhel7-install/vbox/vbox-06-settings4.png[Screenshot Settings RHEL DVD]
...
### Disable lock screen and acreen power saving
