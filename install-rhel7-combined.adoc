...
Download the link:https://developers.stage.redhat.com/download-manager/file/rhel-server-7.2-x86_64-binary.iso[Red Hat Enterprise Linux Server DVD] `.iso` file. [*FIXME STAGING LINK*]
