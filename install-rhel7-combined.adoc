...
image:images/rhel7-install/vbox/win-vbox-02-create.png[Screenshot VirtualBox VM Create]
+
...
image:images/rhel7-install/vbox/win-vbox-05-hd2.png[Screenshot File Location]
...
image:images/rhel7-install/vbox/win-vbox-06-settings1.png[Screenshot VM Created]
...
image:images/rhel7-install/vbox/win-vbox-06-settings4.png[Screenshot Settings RHEL DVD]
