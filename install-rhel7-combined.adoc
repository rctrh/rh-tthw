...
Download the https://developers.stage.redhat.com/download-manager/file/rhel-server-7.2-x86_64-dvd.iso[Red Hat Enterprise Linux Server DVD] `.iso` file.
...
+
[.content-img]
// image:#{cdn(site.base_url + '/images/products/rhel/rhel7-install/vbox/win-vbox-02-create.png')}[Screenshot Boot Splash]
image:images/rhel7-install/vbox/win-vbox-02-create.png[Screenshot Boot Splash]
+
...
image:images/rhel7-install/vbox/win-vbox-05-hd4.png[Screenshot HD Dynamic]
...
image:rhel7-install/vbox/win-vbox-05-hd2.png[Screenshot File Location]
...
image:rhel7-install/vbox/win-vbox-06-settings1.png[Screenshot VM Created]
...
image:images/rhel7-install/vbox/win-vbox-06-settings2.png[Screenshot Settings Advanced]
+
...
image:images/rhel7-install/vbox/win-vbox-06-settings3.png[Screenshot Settings Processor]
+
...
images:rhel7-install/vbox/win-vbox-06-settings4.png[Screenshot Settings RHEL DVD]
...
// image:#{cdn(site.base_url + '/images/products/rhel/rhel7-install/vbox/win-vbox-shared-folder.png')}[Screenshot VirtualBox Shared Folder]
image:images/rhel7-install/vbox/win-vbox-shared-folder.png[Screenshot VirtualBox Shared Folder]
...
* When you <<Install VirtualBox Guest Addition>>, the integration the of mouse pointer will be improved. You will no longer need to hit the _Host Key_ to move the focus outside of the VM window.
...
. Click _Finish configuration_ when you are done.
+
// If you are using an evaluation, you must first agree to the terms and conditions at https://www.redhat.com/wapps/ugc/[www.redhat.com/wapps/ugc, window='_blank'].
+
. Log in to the system with the username and password you created during installation.
+
If you didn't create a regular user, you will need to log in as root and create a user. See <<troubleshooting,Troubleshooting and FAQ>>.
...
http://developerblog.redhat.com/[window='_blank']
